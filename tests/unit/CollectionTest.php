...
class CollectionTest extends \PHPUnit_Framework_TestCase
{
    ...
    /** @test */
    public function items_returned_match_items_passes_in()
    {
        $collection = new \App\Support\Collection([
            'one', 'two'
        ]);
    ...
    /** @test */
    public function returns_json_items()
    {
        $collection = new \App\Support\Collection([
            ['username'=>'alex'],
            ['username'=>'Anurag'],
        ...
        $this->assertEquals('[{"username":"alex"},{"username":"Anurag"}]', $collection->toJson());


    }
    /** @test */
    public function Json_encoding_returns_json()
    {
        $collection = new \App\Support\Collection([
            ['username'=>'alex'],
            ['username'=>'Anurag'],
        ...
        $this->assertEquals('[{"username":"alex"},{"username":"Anurag"}]', $encoded);
